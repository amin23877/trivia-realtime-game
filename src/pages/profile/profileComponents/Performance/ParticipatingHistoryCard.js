	...
	return (
		<div className="participating-history-card">
			...
			<div className="participating-history-card--content">
				<p className="participating-history-card--content__title">{data.title}</p>
				...
				<div className="participating-history-card--content__details">
					<div className="participating-history-card--content__details__score">Score:&nbsp; {data.score}</div>
