    ...
    return (
        <div className="answer-detail w-100 h-100">
            ...
            <div className="answer-detail__question">
                <div className="answer-detail__question--number">
                    {index + 1}
                </div>
            ...
            <div className="answer-detail__timer" style={pauseTimer ? { filter: 'opacity(0.5)' } : {}}>
                <img src={greenTime} />
                <p style={{ color: '#12AE25' }} className="answer-detail__timer--text">20</p>
                <div className="answer-detail__timer--progressbar">
                    <div style={{ backgroundColor: '#12AE25', width: '100%' }} className="answer-detail__timer--progressbar--inside"></div>
                </div>
            </div>
            <div className="answer-detail__options">
                <Button
                    className={`${question.answer == question.option1 ? 'answer-detail__options--true' : ''} ${(question[myInfo.player]?.answer == question.option1 && question[myInfo.player]?.answer != question.answer) ? 'answer-detail__options--false' : ''}`}
                >
                    {
                ...
                <Button
                    className={`${question.answer == question.option2 ? 'answer-detail__options--true' : ''} ${(question[myInfo.player]?.answer == question.option2 && question[myInfo.player]?.answer != question.answer) ? 'answer-detail__options--false' : ''}`}
                >
                    {question.option2}
                    {
                ...
                <Button
                    className={`${question.answer == question.option3 ? 'answer-detail__options--true' : ''} ${(question[myInfo.player]?.answer == question.option3 && question[myInfo.player]?.answer != question.answer) ? 'answer-detail__options--false' : ''}`}
                >
                    {question.option3}
                    {
                ...
                <Button
                    className={`${question.answer == question.option4 ? 'answer-detail__options--true' : ''} ${(question[myInfo.player]?.answer == question.option4 && question[myInfo.player]?.answer != question.answer) ? 'answer-detail__options--false' : ''}`}
                >
                    {question.option4}
                    {
